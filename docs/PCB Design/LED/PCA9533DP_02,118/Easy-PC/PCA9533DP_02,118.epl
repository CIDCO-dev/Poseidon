...
(library Library_1
	...
	(compDef "PCA9533DP_02,118" (originalName "PCA9533DP_02,118") (compHeader (numPins 8) (numParts 1) (refDesPrefix U)
		...
		(compPin "1" (pinName "LED0") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "2" (pinName "LED1") (partNum 1) (symPinNum 2) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "3" (pinName "LED2") (partNum 1) (symPinNum 3) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		...
		(compPin "5" (pinName "LED3") (partNum 1) (symPinNum 8) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		...
		(attr "Datasheet Link" "http://www.nxp.com/docs/en/data-sheet/PCA9533.pdf")
		(attr "Height" "1.1 mm")
	)
