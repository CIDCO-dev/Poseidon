...
bool operator==(const ::inertial_sense::RTKRel_<ContainerAllocator1> & lhs, const ::inertial_sense::RTKRel_<ContainerAllocator2> & rhs)
{
  return lhs.header == rhs.header &&
    lhs.differential_age == rhs.differential_age &&
    lhs.ar_ratio == rhs.ar_ratio &&
    lhs.vector_base_to_rover == rhs.vector_base_to_rover &&
    lhs.distance_base_to_rover == rhs.distance_base_to_rover &&
    lhs.heading_base_to_rover == rhs.heading_base_to_rover;
}
