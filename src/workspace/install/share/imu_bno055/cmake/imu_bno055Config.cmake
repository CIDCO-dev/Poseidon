...
if("FALSE" STREQUAL "TRUE")
  set(imu_bno055_SOURCE_PREFIX /home/ubuntu/Poseidon/src/workspace/src/imu_bno055)
  set(imu_bno055_DEVEL_PREFIX /home/ubuntu/Poseidon/src/workspace/devel)
  ...
  set(imu_bno055_INSTALL_PREFIX /home/ubuntu/Poseidon/src/workspace/install)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'imu_bno055' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '\${prefix}/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT imu_bno055_NUM_DUMMY_TARGETS)
      set(imu_bno055_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::imu_bno055::wrapped-linker-option${imu_bno055_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR imu_bno055_NUM_DUMMY_TARGETS "${imu_bno055_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::imu_bno055::wrapped-linker-option${imu_bno055_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND imu_bno055_LIBRARIES "${interface_target_name}")
