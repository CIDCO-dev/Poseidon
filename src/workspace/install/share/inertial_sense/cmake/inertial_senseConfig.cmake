...
if("FALSE" STREQUAL "TRUE")
  set(inertial_sense_SOURCE_PREFIX /home/ubuntu/Poseidon/src/workspace/src/inertial_sense_ros)
  set(inertial_sense_DEVEL_PREFIX /home/ubuntu/Poseidon/src/workspace/devel)
  ...
  set(inertial_sense_INSTALL_PREFIX /home/ubuntu/Poseidon/src/workspace/install)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'inertial_sense' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '\${prefix}/${idir}'.  ${_report}")
    endif()
    _list_append_unique(inertial_sense_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "inertial_sense_ros")
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT inertial_sense_NUM_DUMMY_TARGETS)
      set(inertial_sense_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::inertial_sense::wrapped-linker-option${inertial_sense_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR inertial_sense_NUM_DUMMY_TARGETS "${inertial_sense_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::inertial_sense::wrapped-linker-option${inertial_sense_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND inertial_sense_LIBRARIES "${interface_target_name}")
